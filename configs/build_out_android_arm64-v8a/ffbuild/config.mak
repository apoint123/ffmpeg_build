...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-everything --disable-programs --disable-network --disable-doc --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --disable-avdevice --disable-avfilter --disable-swscale --enable-protocol=file --disable-autodetect --disable-asm --disable-x86asm --disable-inline-asm --enable-demuxer='aac,ac3,aiff,ape,asf,flac,matroska,mov,mp3,ogg,wav,wv,amr,au,dts,dtshd,m4v,mpc,mpc8,rm,tak,tta,truehd,dsf,dff' --enable-decoder='aac,aac_latm,ac3,alac,als,ape,flac,mp3,opus,pcm_alaw,pcm_f32be,pcm_f32le,pcm_f64be,pcm_f64le,pcm_mulaw,pcm_s16be,pcm_s16le,pcm_s24be,pcm_s24le,pcm_s32be,pcm_s32le,pcm_s8,pcm_u16be,pcm_u16le,pcm_u24be,pcm_u24le,pcm_u32be,pcm_u32le,pcm_u8,vorbis,wavpack,wmalossless,wmapro,wmav1,wmav2,wmavoice,amrnb,amrwb,cook,dca,eac3,mlp,mpc7,mpc8,ra_144,ra_288,shorten,tak,tta,truehd,dsd_lsbf,dsd_msbf,dsd_lsbf_planar,dsd_msbf_planar' --enable-parser='aac,aac_latm,ac3,cook,dca,flac,mlp,mpegaudio,opus,vorbis,tak,amr,sipr' --target-os=android --enable-cross-compile --arch=aarch64 --cc=/usr/local/lib/android/sdk/ndk/29.0.14206865/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android26-clang
prefix=/usr/local
...
INSTALL_NAME_DIR=
SRC_PATH=/home/runner/work/ffmpeg-config/ffmpeg-config/ffmpeg
SRC_LINK=src
...
INTRINSICS=none
EXTERN_PREFIX=
CC=/usr/local/lib/android/sdk/ndk/29.0.14206865/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android26-clang
CXX=g++
AS=/usr/local/lib/android/sdk/ndk/29.0.14206865/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android26-clang
OBJCC=/usr/local/lib/android/sdk/ndk/29.0.14206865/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android26-clang
LD=/usr/local/lib/android/sdk/ndk/29.0.14206865/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android26-clang
DEPCC=/usr/local/lib/android/sdk/ndk/29.0.14206865/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android26-clang
DEPCCFLAGS= $(CPPFLAGS)
DEPCXX=/usr/local/lib/android/sdk/ndk/29.0.14206865/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android26-clang
DEPCXXFLAGS= $(CPPFLAGS)
DEPAS=/usr/local/lib/android/sdk/ndk/29.0.14206865/toolchains/llvm/prebuilt/linux-x86_64/bin/aarch64-linux-android26-clang
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC11_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -I$(SRC_PATH)/compat/stdbit
CFLAGS=   -std=c17 -fPIE -fomit-frame-pointer -fPIC -pthread -g -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wmissing-prototypes -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Wno-implicit-const-int-float-conversion -Wno-microsoft-enum-forward-reference -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
CXXFLAGS=   -D__STDC_CONSTANT_MACROS -std=c++17 -fPIE -fomit-frame-pointer -fPIC -pthread -g -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wstack-usage=122880 -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -O3 -fno-math-errno -fno-signed-zeros -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
OBJCFLAGS=   -fPIE -fomit-frame-pointer -fPIC -pthread -g -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Wno-unused-const-variable -Wno-bool-operation -Wno-char-subscripts -Wno-implicit-const-int-float-conversion -Wno-microsoft-enum-forward-reference -O3 -fno-math-errno -fno-signed-zeros -mstack-alignment=16 -Qunused-arguments -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type
