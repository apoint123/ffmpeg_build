...
CC_IDENT=Microsoft (R) C/C++ Optimizing Compiler Version 19.44.35227 for x64
ARCH=c
INTRINSICS=none
EXTERN_PREFIX=
CC=cl.exe
...
CFLAGS= -nologo -options:strict  /std:c17  -Z7 -W3 -wd4018 -wd4146 -wd4244 -wd4305 -wd4554 -wd4267 -O2   -utf-8
CXXFLAGS= -nologo -Zc:__cplusplus -EHsc  -D__STDC_CONSTANT_MACROS /std:c++17  -Z7 -O2  
OBJCFLAGS= -nologo  -Z7
ASFLAGS= -nologo  -Z7
GLSLCFLAGS=
NVCCFLAGS=--cuda-gpu-arch=sm_30 -O2 -std=c++11 -m64 -S -nocudalib -nocudainc --cuda-device-only -Wno-c++11-narrowing -include /d/a/ffmpeg-config/ffmpeg-config/ffmpeg/compat/cuda/cuda_runtime.h
AS_C=-c
AS_O=-Fo$@
OBJCC_C=-c
OBJCC_E=-E -o $@
