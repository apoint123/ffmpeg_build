...
INSTALL_NAME_DIR=
SRC_PATH=/d/a/ffmpeg-config/ffmpeg-config/ffmpeg
SRC_LINK=/d/a/ffmpeg-config/ffmpeg-config/ffmpeg
ifndef MAIN_MAKEFILE
SRC_PATH:=$(SRC_PATH:.%=..%)
endif
CC_IDENT=Microsoft (R) C/C++ Optimizing Compiler Version 19.44.35227 for x86
ARCH=c
INTRINSICS=none
EXTERN_PREFIX=_
CC=cl.exe
...
AS=cl.exe
OBJCC=cl.exe
LD=/d/a/ffmpeg-config/ffmpeg-config/ffmpeg/compat/windows/mslink
DEPCC=cl.exe
DEPCCFLAGS=-nologo $(CPPFLAGS)
DEPCXX=cl.exe
DEPCXXFLAGS=-nologo $(CPPFLAGS)
DEPAS=cl.exe
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC11_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DWIN32_LEAN_AND_MEAN -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS -D_WIN32_WINNT=0x0600 -I$(SRC_PATH)/compat/atomics/win32 -I$(SRC_PATH)/compat/stdbit
CFLAGS= -nologo -options:strict  /std:c17  -Z7 -W3 -wd4018 -wd4146 -wd4244 -wd4305 -wd4554 -wd4267 -O2   -Oy- -utf-8
CXXFLAGS= -nologo -Zc:__cplusplus -EHsc  -D__STDC_CONSTANT_MACROS /std:c++17  -Z7 -O2  
OBJCFLAGS= -nologo  -Z7
ASFLAGS= -nologo  -Z7
GLSLCFLAGS=
NVCCFLAGS=--cuda-gpu-arch=sm_30 -O2 -std=c++11 -m32 -S -nocudalib -nocudainc --cuda-device-only -Wno-c++11-narrowing -include /d/a/ffmpeg-config/ffmpeg-config/ffmpeg/compat/cuda/cuda_runtime.h
AS_C=-c
AS_O=-Fo$@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
LD_PATH=-libpath:
DLLTOOL=
WINDRES=/d/a/ffmpeg-config/ffmpeg-config/ffmpeg/compat/windows/mswindres
DOXYGEN=doxygen
...
CCDEP_FLAGS=$(CPPFLAGS) -showIncludes -Zs $(CFLAGS)
CXXDEP_FLAGS=$(CPPFLAGS) -showIncludes -Zs $(CXXFLAGS)
ASDEP=$(DEP$(1)) $(DEP$(1)FLAGS) $($(1)DEP_FLAGS) $< 2>&1 | awk '/including/ { sub(/^.*file: */, ""); gsub(/\\/, "/"); if (!match($$0, / /)) print "$@:", $$0 }' > $(@:.o=.d)
ASDEP_FLAGS=$(CPPFLAGS) -showIncludes -Zs 
CC_DEPFLAGS=
CXX_DEPFLAGS=
OBJCC_DEPFLAGS=
AS_DEPFLAGS=
...
HOSTCC=cl.exe
HOSTLD=cl.exe
HOSTCFLAGS= -nologo -options:strict /std:c17 -W3 -wd4018 -wd4146 -wd4244 -wd4305 -wd4554 -wd4267 -O2
HOSTCPPFLAGS= -D_ISOC11_SOURCE -D_USE_MATH_DEFINES -D_CRT_SECURE_NO_WARNINGS -D_CRT_NONSTDC_NO_WARNINGS -D_WIN32_WINNT=0x0600
HOSTEXESUF=.exe
HOSTLDFLAGS= -nologo
HOSTEXTRALIBS=-lm
DEPHOSTCC=cl.exe
...
HOSTCCDEP_FLAGS=$(CPPFLAGS) -showIncludes -Zs 
HOSTCC_DEPFLAGS=
HOSTCC_C=-c
HOSTCC_O=-Fo$@
HOSTLD_O=-Fe$@
